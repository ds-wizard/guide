...
- **Update** - if there is a newer version of the parent knowledge model, we can use the update action to start a :ref:`knowledge model migration<knowledge-model-migration>`, otherwise the action is not visible
